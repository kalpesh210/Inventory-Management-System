        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                   <center>
                  <h1>ADD PROCESSED MATERIAL</h1>
                      </center>
                     <fieldset>
  <form action="proadd"mathod="post"id="survey-form">
      <label id="name-label"> <b>Enter Id</b> </label><input id="name" type="number"name="id" placeholder="Id" required/><br>  
              <select name = "name" id = "name">     
              	<option>Select Material</option>
           <option value=" Metal Furniture "> Metal Furniture </option>
           <option value="Wooden Furniture "> Wooden Furniture </option>
            <option value=" Copper Furniture"> Copper Furniture </option>
             <option value="Bronze"> Bronze</option>
            <option value="Sausage"> Sausage </option>
           </select>         
          <label id="email-label"> <b>Enter Quantity</b> </label><input id="email" type="number"name="quantity"  required/> 
            <label id="number-label"> <b>Enter Unit</b> </label><input id="number" type="text" name="unit" required/>
			<label id="number-label"> <b>Cost per unit</b> </label><input id="number" type="number" name="cost" required/><br>
             <center>
