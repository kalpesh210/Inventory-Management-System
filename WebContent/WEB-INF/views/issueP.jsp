 ...
 <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="login"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Dashboard</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                   <center>
                   <h1>Issue Processed Material</h1>
                      </center>
                     <fieldset>
  <form action="issuep"mathod="post"id="survey-form">
      <label id="name-label"> <b>Enter ID</b> </label><input id="name" type="number"name="id"  required/>
      <input type="hidden" name="name" value="<%=request.getParameter("name") %>">
          <label id="email-label"> <b>Enter Quantity</b> </label><input id="email" type="number"name="quantity"  required/> 
           <label id="lastname-label"> <b>Issuer Name</b> </label><input id="name" name="issuer_name"type="text" required/> 
            <label id="number-label"> <b>Date</b> </label><input id="number" type="date" name="date"  required/>
		<input type="hidden" name="itemid" value="<%=request.getParameter("id")%>">
			<input type="hidden" name="cost" value="<%=request.getParameter("cost")%>">
             <center>
        <input id="submit" type="submit" name="ISSUE">
           </center>
          </fieldset> 
